          ...
          <div className="d-flex align-items-center order-lg-3">
            <ul className="nav nav-tools flex-nowrap">
              ...
              <li className="nav-item align-self-center mb-0">
                <a href="#" className="nav-tool pr-lg-0" data-toggle="offcanvas" data-target="cart">
                  <i className="cxi-cart nav-tool-icon"></i>
                  <span className="badge badge-success align-middle mt-n1 ml-2 px-2 py-1 font-size-xs">4</span>
                </a>
              </li>
              <li className="divider-vertical mb-0 d-lg-none d-block"></li>
              <li className="nav-item mb-0">
                <button className="navbar-toggler mt-n1 mr-n3" type="button" data-toggle="collapse" data-target="#navbarCollapse" aria-expanded="false">
